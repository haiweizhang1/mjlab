...
run_name="DepthStudent_KlavierTeacher47000_ConstrainedLastMLP_Latent01_Mixed030_SyncDelay02_MountRange025_seed42_from24000_stage2_10k_wandb"
...
exec uv run train \
  Mjlab-Velocity-Football-Depth-KlavierTeacher-MountRangeVisualDR-ConstrainedMLP-LatentDistillation-Flat-Unitree-G1 \
