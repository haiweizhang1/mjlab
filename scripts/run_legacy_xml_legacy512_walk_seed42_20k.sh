...
export WARP_CACHE_PATH="${WARP_CACHE_PATH:-/tmp/mjlab-warp-walk-legacy-xml}"
export MPLCONFIGDIR="${MPLCONFIGDIR:-/tmp/mjlab-mpl-walk-legacy-xml}"
export XDG_CACHE_HOME="${XDG_CACHE_HOME:-/tmp/mjlab-xdg-walk-legacy-xml}"
...
exec "$train_entrypoint" \
  ...
  --agent.run-name LegacyXML_Legacy512_LegacyPush_NoSym_seed42_20k_wandb
