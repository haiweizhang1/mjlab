    ...
    while not file_saved:
        ...
        if not file_saved:
            ...
            if reset_flag and not file_saved:
                ...
                save_path = f"npz_mjlab_g1/{output_name}.npz" if not output_name.endswith(".npz") else output_name
                ...
                if render and frames:
                    ...
                    print("📹 开始生成本地视频...")
                    video_path = f"npz_mjlab_g1/{output_name}.mp4" if not output_name.endswith(".mp4") else output_name
