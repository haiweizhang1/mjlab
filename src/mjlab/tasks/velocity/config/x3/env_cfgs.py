"""Droid 系统 flat tracking environment configurations."""
...
def droid_x3_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
...
def droid_x3_flat_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create Unitree G1 flat terrain velocity configuration."""
  cfg = droid_x3_rough_env_cfg(play=play)
