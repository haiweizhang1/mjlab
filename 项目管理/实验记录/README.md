...
| KLAVIER512-PAIR | 2026-08-31 | Walk512 20k → 足球 Teacher 球观测 0/5cm 对照 | Planned / Implemented | `soccer/train`，commit 待本轮固化 | 固定旧版推力、无推力课程；两个 Teacher 仅改变球位置观测噪声 | 待训练 | Walk 目标 `model_20000.pt`；Teacher 各 50k | [完整配置与指令](EXP-20260831-Klavier512-Walk双Teacher与E1二阶段.md) |
| DEPTH-E1-STAGE2 | 2026-08-31 | E1 model_27000 二阶段额外 30k | Planned / Implemented | `soccer/train`，commit 待本轮固化 | PushCurrOff、NoSym、Mixed030；仅开放 MLP 最后一层 | 待训练 | 最终强制保存预计为 `model_56999.pt` | [完整配置与指令](EXP-20260831-Klavier512-Walk双Teacher与E1二阶段.md) |
